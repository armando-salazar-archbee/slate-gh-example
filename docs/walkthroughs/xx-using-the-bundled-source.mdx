---
title: Using the Bundled Source
docTags: 
createdAt: Wed Jul 01 2026 16:39:05 GMT+0000 (Coordinated Universal Time)
---

For most folks, you'll want to install Slate via `npm`, in which case you can follow the regular [Installing Slate](01-installing-slate.mdx) guide.

...
- :Link[Instantiation methods]{label="Instantiation methods" overridedLabel="Instantiation methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#instantiation-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
- :Link[Static methods]{label="Static methods" overridedLabel="Static methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#static-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Retrieval methods]{label="Retrieval methods" overridedLabel="Retrieval methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#retrieval-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Manipulation methods]{label="Manipulation methods" overridedLabel="Manipulation methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#manipulation-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Check methods]{label="Check methods" overridedLabel="Check methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#check-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Normalization methods]{label="Normalization methods" overridedLabel="Normalization methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#normalization-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Ref methods]{label="Ref methods" overridedLabel="Ref methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#ref-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
- :Link[Instance methods]{label="Instance methods" overridedLabel="Instance methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#instance-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Schema-specific methods to override]{label="Schema-specific methods to override" overridedLabel="Schema-specific methods to override" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#schema-specific-instance-methods-to-override" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Element Type Methods]{label="Element Type Methods" overridedLabel="Element Type Methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#element-type-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Normalize Method]{label="Normalize Method" overridedLabel="Normalize Method" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#normalize-method" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Callback Method]{label="Callback Method" overridedLabel="Callback Method" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#callback-method" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Mark Methods]{label="Mark Methods" overridedLabel="Mark Methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#mark-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[getFragment Method]{label="getFragment Method" overridedLabel="getFragment Method" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#getfragment-method" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Delete Methods]{label="Delete Methods" overridedLabel="Delete Methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#delete-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Insert Methods]{label="Insert Methods" overridedLabel="Insert Methods" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#insert-methods" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
  - :Link[Operation Handling Method]{label="Operation Handling Method" overridedLabel="Operation Handling Method" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#operation-handling-method" loadingMethod="dynamic" newTab="false" href="editor.mdx"}
...
If the selection is currently expanded, it will be deleted first. To atomically insert nodes (including at the very beginning or end), use :Link[Transforms.insertNodes]{label="Transforms.insertNodes" overridedLabel="Transforms.insertNodes" spaceId docId="XMjJd_pcFnxBJHu5rKQm1" version="v2" docAnchorId="#transformsinsertnodeseditor-editor-nodes-node--node-options" loadingMethod="dynamic" newTab="false" githubPath="../transforms.mdx" href="../transforms.mdx"}.
...
See :Link[Normalization - Implications for Other Code]{label="Normalization - Implications for Other Code" overridedLabel="Normalization - Implications for Other Code" spaceId docId="uGGBOJCZ9XN4Dstm9T5v5" version="v2" docAnchorId="#implications-for-other-code" loadingMethod="dynamic" newTab="false" href="editor.mdx"};
...
Use these methods so that Slate can identify certain elements as :Link[inlines]{label="inlines" overridedLabel="inlines" spaceId docId="PvfknVayq1-FbWpI6GYWP" version="v2" docAnchorId="#blocks-vs-inlines" loadingMethod="dynamic" newTab="false" githubPath="../../concepts/02-nodes.mdx" href="../../concepts/02-nodes.mdx"} or :Link[voids]{label="voids" overridedLabel="voids" spaceId docId="PvfknVayq1-FbWpI6GYWP" version="v2" docAnchorId="#voids" loadingMethod="dynamic" newTab="false" githubPath="../../concepts/02-nodes.mdx" href="../../concepts/02-nodes.mdx"}.

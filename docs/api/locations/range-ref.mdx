...
- :Link[Instance methods]{label="Instance methods" overridedLabel="Instance methods" spaceId docId="_v4Lo4BuZ6NcB5ZeAJfGz" version="v2" docAnchorId="#instance-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}
- :Link[Static methods]{label="Static methods" overridedLabel="Static methods" spaceId docId="_v4Lo4BuZ6NcB5ZeAJfGz" version="v2" docAnchorId="#static-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}
  - :Link[Transform methods]{label="Transform methods" overridedLabel="Transform methods" spaceId docId="_v4Lo4BuZ6NcB5ZeAJfGz" version="v2" docAnchorId="#transform-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}

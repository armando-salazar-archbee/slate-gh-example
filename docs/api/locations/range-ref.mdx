...
- :Link[Instance methods]{label="Instance methods" overridedLabel="Instance methods" spaceId docId="qBC6BKh1OAqz5Q9X6c_wq" version="v2" docAnchorId="#instance-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}
- :Link[Static methods]{label="Static methods" overridedLabel="Static methods" spaceId docId="qBC6BKh1OAqz5Q9X6c_wq" version="v2" docAnchorId="#static-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}
  - :Link[Transform methods]{label="Transform methods" overridedLabel="Transform methods" spaceId docId="qBC6BKh1OAqz5Q9X6c_wq" version="v2" docAnchorId="#transform-methods" loadingMethod="dynamic" newTab="false" href="range-ref.mdx"}

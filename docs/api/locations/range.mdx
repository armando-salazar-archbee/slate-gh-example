...
- :Link[Static methods]{label="Static methods" overridedLabel="Static methods" spaceId docId="1jn24yv5dFHwmXAHAk_Bo" version="v2" docAnchorId="#static-methods" loadingMethod="dynamic" newTab="false" href="range.mdx"}
  - :Link[Retrieval methods]{label="Retrieval methods" overridedLabel="Retrieval methods" spaceId docId="1jn24yv5dFHwmXAHAk_Bo" version="v2" docAnchorId="#retrieval-methods" loadingMethod="dynamic" newTab="false" href="range.mdx"}
  - :Link[Check methods]{label="Check methods" overridedLabel="Check methods" spaceId docId="1jn24yv5dFHwmXAHAk_Bo" version="v2" docAnchorId="#check-methods" loadingMethod="dynamic" newTab="false" href="range.mdx"}
  - :Link[Transform methods]{label="Transform methods" overridedLabel="Transform methods" spaceId docId="1jn24yv5dFHwmXAHAk_Bo" version="v2" docAnchorId="#transform-methods" loadingMethod="dynamic" newTab="false" href="range.mdx"}

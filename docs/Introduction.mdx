...
<hint type="info">
  :inlineImage[]{src="https://api.archbee.com/api/optimize/nnXudRKm4KkQ_ECeAi3d2/KSkBhoJx5__5rr6MINEjg_image.png" alt caption width="500" height="512"} **This is a GitHub-connected repository.**
</hint>

[Slate](http://slatejs.org) is a *completely* customizable framework for building rich text editors.

## New line coming from GitHub

<hint type="danger">
  Warning! Do not delete.
</hint>

This is my new line. Follow these steps:

![](https://api.archbee.com/api/optimize/nnXudRKm4KkQ_ECeAi3d2/mc_9aFJo-brflB0P6GK5x_slack.png)
...
This section includes the overview of my documentation.

<hint type="success">
  ✅  **Archbee change to Git**

  This change will reach the Git repository 🚀
</hint>
...
<Tabs>
  <Tab title="Tab 1">
    ...
    <embed url="https://www.youtube.com/watch?v=BZoYneeqxzM">

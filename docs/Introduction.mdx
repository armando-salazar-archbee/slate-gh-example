...
Slate tries to solve the question of ":Link[Why?]{label="Why?" overridedLabel="Why?" spaceId docId="KZYa729q4EbYFxM78fVEm" version="v2" docAnchorId="#OpEvG" loadingMethod="dynamic" newTab="false" href="./#why"}" with a few principles:

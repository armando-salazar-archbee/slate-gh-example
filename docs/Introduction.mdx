...
Slate tries to solve the question of ":Link[Why?]{label="Why?" overridedLabel="Why?" spaceId docId="KZYa729q4EbYFxM78fVEm" version="v2" docAnchorId="#k2p2Z" loadingMethod="dynamic" newTab="false" href="./#why"}" with a few principles:
...
All contributions are super welcome! Check out the [Contributing instructions](general/contributing.mdx) for more info!

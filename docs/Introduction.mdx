...
<hint type="info">
  :inlineImage[]{src="https://api.archbee.com/api/optimize/nnXudRKm4KkQ_ECeAi3d2/KSkBhoJx5__5rr6MINEjg_image.png" alt caption} **This is a GitHub-connected repository.**
</hint>
...
Slate tries to solve the question of ":Link[Why?]{label="Why?" overridedLabel="Why?" spaceId docId="KZYa729q4EbYFxM78fVEm" version="v2" docAnchorId="#why" loadingMethod="dynamic" newTab="false" href="Introduction.mdx"}" with a few principles:

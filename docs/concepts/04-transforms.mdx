...
<BlockQuote>
  🤖 Check out the [Transforms](../api/transforms.mdx) reference for a full list of Slate's transforms.
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Selection Transforms API Reference]{label="Selection Transforms API Reference" overridedLabel="Selection Transforms API Reference" spaceId docId="IVORSdNtr--7lBFULlsy_" version="v2" docAnchorId="#selection-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.md#selection-transforms" href="../api/transforms.mdx"}
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Text Transforms API Reference]{label="Text Transforms API Reference" overridedLabel="Text Transforms API Reference" spaceId docId="IVORSdNtr--7lBFULlsy_" version="v2" docAnchorId="#text-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.md#text-transforms" href="../api/transforms.mdx"}
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Node Transforms API Reference]{label="Node Transforms API Reference" overridedLabel="Node Transforms API Reference" spaceId docId="IVORSdNtr--7lBFULlsy_" version="v2" docAnchorId="#node-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.md#node-transforms" href="../api/transforms.mdx"}
</BlockQuote>
...
Sequences of Transforms may need to be wrapped in :Link[Editor.withoutNormalizing]{label="Editor.withoutNormalizing" overridedLabel="Editor.withoutNormalizing" spaceId docId="HY2UgAi1FnVsaA53xavyP" version="v2" docAnchorId="#editorwithoutnormalizingeditor-editor-fn---void--void" loadingMethod="dynamic" newTab="false" githubPath="../api/nodes/editor.md#editorwithoutnormalizingeditor-editor-fn---void--void" href="../api/nodes/editor.mdx"} if the node tree should *not* be normalized between Transforms.
See :Link[Normalization - Implications for Other Code]{label="Normalization - Implications for Other Code" overridedLabel="Normalization - Implications for Other Code" spaceId docId="bcRuSc6m1F9SiQ_sqbobu" version="v2" docAnchorId="#implications-for-other-code" loadingMethod="dynamic" newTab="false" githubPath="./11-normalizing.md#implications-for-other-code" href="11-normalizing.mdx"};

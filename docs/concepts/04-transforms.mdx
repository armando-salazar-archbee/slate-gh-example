...
<BlockQuote>
  🤖 For more info, check out the :Link[Selection Transforms API Reference]{label="Selection Transforms API Reference" overridedLabel="Selection Transforms API Reference" spaceId docId="THG18eNo-gBQZu-Fur_Hn" version="v2" docAnchorId="#selection-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.mdx" href="../api/transforms.mdx"}
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Text Transforms API Reference]{label="Text Transforms API Reference" overridedLabel="Text Transforms API Reference" spaceId docId="THG18eNo-gBQZu-Fur_Hn" version="v2" docAnchorId="#text-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.mdx" href="../api/transforms.mdx"}
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Node Transforms API Reference]{label="Node Transforms API Reference" overridedLabel="Node Transforms API Reference" spaceId docId="THG18eNo-gBQZu-Fur_Hn" version="v2" docAnchorId="#node-transforms" loadingMethod="dynamic" newTab="false" githubPath="../api/transforms.mdx" href="../api/transforms.mdx"}
</BlockQuote>
...
Sequences of Transforms may need to be wrapped in :Link[Editor.withoutNormalizing]{label="Editor.withoutNormalizing" overridedLabel="Editor.withoutNormalizing" spaceId docId="ijNwT9zHJuU6WWdHzdK5O" version="v2" docAnchorId="#editorwithoutnormalizingeditor-editor-fn---void--void" loadingMethod="dynamic" newTab="false" githubPath="../api/nodes/editor.mdx" href="../api/nodes/editor.mdx"} if the node tree should *not* be normalized between Transforms.
See :Link[Normalization - Implications for Other Code]{label="Normalization - Implications for Other Code" overridedLabel="Normalization - Implications for Other Code" spaceId docId="hAPvTfXQqQ_lCck4iG5lp" version="v2" docAnchorId="#implications-for-other-code" loadingMethod="dynamic" newTab="false" githubPath="11-normalizing.mdx" href="11-normalizing.mdx"};

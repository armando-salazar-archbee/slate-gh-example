...
Don't set it directly; use :Link[Transforms.select]{label="Transforms.select" overridedLabel="Transforms.select" spaceId docId="TYwAMhDZ2Psmev3O9mcLr" version="v2" docAnchorId="#selection-transforms" loadingMethod="dynamic" newTab="false" href="07-editor.mdx"}
...
<BlockQuote>
  🤖 For more info, check out the :Link[Editor Instance Methods to Override API Reference]{label="Editor Instance Methods to Override API Reference" overridedLabel="Editor Instance Methods to Override API Reference" spaceId docId="7pyjqn7_AQEYjNiOT0rQ3" version="v2" docAnchorId="#schema-specific-instance-methods-to-override" loadingMethod="dynamic" newTab="false" githubPath="../api/nodes/editor.mdx" href="../api/nodes/editor.mdx"}
</BlockQuote>
...
<BlockQuote>
  🤖 For more info, check out the :Link[Editor Static Methods API Reference]{label="Editor Static Methods API Reference" overridedLabel="Editor Static Methods API Reference" spaceId docId="7pyjqn7_AQEYjNiOT0rQ3" version="v2" docAnchorId="#static-methods" loadingMethod="dynamic" newTab="false" githubPath="../api/nodes/editor.mdx" href="../api/nodes/editor.mdx"}
</BlockQuote>
